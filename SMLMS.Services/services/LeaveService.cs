...
namespace SMLMS.Services.services
{
    public class LeaveService : ILeaveService
    {
        ...
        public async Task<ServiceResponse> RequestLeave(RequestLeave _RequestLeave, ClaimsPrincipal claim)
        {
                ...
                try
                {
                _RequestLeave.DepartmentId = Guid.Parse(deptid);
        ...
        public async Task<ServiceResponse> ApproveLeaveRequest(Guid id, ClaimsPrincipal claim)
        {
                ...
                try
                {
                    ...
                    {
                        Id = id,
                        UpdatedBy = aprovalByName //  reject or  may be approval
        ...
        public async Task<ServiceResponse> RejectLeaveRequest(RejectLeave model, ClaimsPrincipal claim)
        {
            ServiceResponse response = new ServiceResponse();
            try
            {
                ...
                unitOfWork.LeaveRepositry.RejectLeaveRequest(requestLeave);
                unitOfWork.Commit();
                response.IsSuccess = true;
            }
            catch (Exception ex)
        ...
        public async Task<ServiceResponse> GetLeaveByDepartmentId(Guid id)
        {
            ServiceResponse _response = new ServiceResponse();
            try
            {
                var taskList = unitOfWork.LeaveRepositry.FindByDepartmentId(id);
                unitOfWork.Commit();
                _response.IsSuccess = true;
